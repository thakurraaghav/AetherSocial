        ...
        <div className="w-full md:w-1/2 p-[40px] md:p-[64px] flex flex-col justify-center relative bg-[#0c1324]/50 backdrop-blur-xl">
          ...
          <div className="max-w-[400px] mx-auto w-full">
            <div className="mb-[40px]">
              <h1 className="font-['Inter'] text-[32px] leading-[40px] tracking-[-0.01em] font-semibold text-[#dce1fb] mb-[8px] hidden md:block">Welcome Back</h1>
              <p className="font-['Inter'] text-[14px] leading-[20px] font-normal text-[#c7c4d8]">Authenticate to access your command center.</p>
            </div>
            ...
            <div className="mt-[40px] text-center">
              <p className="font-['Inter'] text-[14px] leading-[20px] font-normal text-[#464555]">
                Don't have an account? <Link className="text-[#c3c0ff] hover:text-[#e2dfff] transition-colors font-medium" to="/register">Sign Up</Link>
              </p>
            </div>
          </div>
        </div>
